...
$codigo_rubro = $_REQUEST['codigo'];
	...
	$conexion = oci_connect("$usuario_conn","$pass_conn", "$ip/$instancia");
		...
		$sql = "SELECT CODIGO, DESCRIP FROM COS_RUBRO where CODIGO='$codigo_rubro'";
 ...
 ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Editar T.Gasto
    </h1>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modulos/Rubros/modificar.php" method="POST">
            <div class="box-body">
