...
if ($item_ok==1){
	...
	echo "<script> /*alert('Registro Insertado');*/ document.location.href='../../main.php?modulo=gasto_item&item=$codigoitem&descrip_item=$descrip_item_ver';</script>";
	//	echo 'echo';
}else {

	echo "<script>alert('Error en el Item seleccionado'); document.location.href='../../main.php?modulo=Gastos';</script>";
	//	echo 'no echo';
}
